...
###################################################################
#  Shows how to send a wireless text message through proxy in Perl.
# 
...
$sms->proxyType("http");
$sms->proxyServer("myproxy.mydomain.com");
$sms->proxyPort(8080);
$sms->proxyUsername("myusername");
$sms->proxyPassword("mypassword");
