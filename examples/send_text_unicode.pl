...
$r->msgText( "Hello World from Simplewire! \xA9 " );
$r->optDataCoding( "UCS2" );
...
# -- Unicode Support --
# For Unicode characters in the range 0x00 to 0xFF,
# you can use the Perl hexadecimal escape sequence.
#	Format: \x##
